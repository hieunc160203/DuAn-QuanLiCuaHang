 ...
 * @author Admin
 */
public class ThemMoiPhieuKiemJFrame extends javax.swing.JFrame {

    /**
     * Creates new form ThemMoiPhieuKiemJFrame
     */
    public ThemMoiPhieuKiemJFrame() {
        initComponents();
        inIt();
    }
    ...
    private void initComponents() {
        ...
        tbl_ChiTietPhieuKiem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_ChiTietPhieuKiemMouseClicked(evt);
            }
        });
    ...
    private void tbl_ChiTietPhieuKiemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_ChiTietPhieuKiemMouseClicked
        // TODO add your handling code here:
        if (evt.getClickCount() == 2) {
            xoaSanPham();
        }
    }//GEN-LAST:event_tbl_ChiTietPhieuKiemMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemMoiPhieuKiemJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void doThongTin() {
        try {
            ...
            int demPhieu = PhieuKiemDAO.demPhieuKiem();
            String MaPhieuKiem = "PK" + (demPhieu+1);
            txt_MaChungTu.setText(MaPhieuKiem);
            // khởi tạo ngày tạo phiếu
            dat_NgayTao.setDate(DateHelper.now());
        } catch (Exception e) {
    ...
    /*
     * Hàm thêm sản phẩm ở tbl_DSSP vào phiếu kiểm ở tbl_ChiTietPhieuKiem
     */
    void themSanPham() {
        ...
        try {
            ...
            if (DSSP.containsKey(SP)) 
                DialogHelper.alert(this, "Sản phẩm đã có trong danh sách kiểm kê");
            else {
                DSSP.put(SP, -1);
    ...
    void luuTam() {
        if (xetDangNhap() && kiemGhiChu() && kiemDSSP()) {
            ...
            try {
                int rs = PhieuKiemDAO.themPhieuTam(PK);
                themPKCT(PK);
                if (rs > 0) {
    ...
    /*
     * Hàm xoá sản phẩm trong danh sách kiểm kê khi click chọn
     */
    void xoaSanPham() {
        int index = tbl_ChiTietPhieuKiem.getSelectedRow();
        String MaSP = tbl_ChiTietPhieuKiem.getValueAt(index, 1).toString();
        try {
            SanPham SP = SanPhamDAO.timTheoMaSP(MaSP);
            if (DialogHelper.confirm(this, "Xoá sản phẩm " + MaSP + "khỏi danh sách kiểm kê?")) {
                DSSP.remove(SP);
                capnhatDanhSachKiemKe();
            }
        } catch (Exception e) {
