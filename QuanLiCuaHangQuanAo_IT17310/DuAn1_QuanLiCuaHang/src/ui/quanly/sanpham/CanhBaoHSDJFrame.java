...
import ui.quanly.giaodich.ThemMoiPhieuHuyJFrame;
...
public class CanhBaoHSDJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_DanhSachSanPham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Mã SP", "Tên sản phẩm", "HSD gần nhất", "HSD mới", "Tồn kho", "Trạng thái"
            }
        ) {
    ...
    // list chua maSP duoc chon de ngung kinh doanh hoac xuat huy
    static List<String> listTam = new ArrayList<>();
    
    /*
     * Hàm khởi tạo các giá trị ban đầu cho JFrame
     */
    void inIt() {
        setTitle("Cảnh báo HSD");
        setResizable(false);
        setLocationRelativeTo(null);
        btn_NgungBan.setVisible(false);
        btn_XuatHuy.setVisible(false);
        doNhomHang();
        capnhatDuLieu();
    }
    ...
    void doDuLieuVaoBang(List<SanPham> listSP) throws SQLException{
        ...
        for(SanPham SP : listSP){
            ...
            Object[] row = {false, 
                            ...
                            HSDMoiNhat,
                            SP.getTonKho(),
                            SP.getTrangThai() ? "Đang bán" : "Ngưng bán"
                            };
            dtm.addRow(row);
        }
    }
    ...
    void taoDanhSachDangChon() {
        ...
        if (!listTam.isEmpty()) {
            btn_NgungBan.setVisible(true);
            btn_XuatHuy.setVisible(true);
        }
        else {
            btn_NgungBan.setVisible(false);
            btn_XuatHuy.setVisible(false);
    ...
    /*
     * Hàm đổ DSSP vào list đề nghị huỷ và mở frame thêm mới phiếu huỷ
     */
    void huySanPham() {
        try {
            for (String MaSP : listTam) {
                SanPham SP = SanPhamDAO.timTheoMaSP(MaSP);
                ShareHelper.listDeNghiHuy.add(SP);
            }
