 ...
 * @author Phu Phan
 */
public class ThemMoiSanPhamJFrame extends javax.swing.JFrame {

    /**
     * Creates new form ThemMoiSanPhamJFrame
     */
    public ThemMoiSanPhamJFrame() {
        initComponents();
        inIt();
    }
    ...
    private void initComponents() {
        ...
        chk_KhongDuocPhepBan.setSelected(true);
        chk_KhongDuocPhepBan.setText("Không được phép bán");
        chk_KhongDuocPhepBan.setEnabled(false);
        ...
        dat_HSDGanNhat.setEnabled(false);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(txt_GiaBan, javax.swing.GroupLayout.PREFERRED_SIZE, 408, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(dat_HSDGanNhat, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(13, 13, 13))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lbl_Hinh, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemMoiSanPhamJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void doMaSP() throws SQLException {
        int dem = SanPhamDAO.demSanPham() + 1;
        String MaSP = "SP" + dem;
    ...
    void doNCC() throws SQLException {
        ...
        for (NhaCungCap NCC : listNCC) {
            // chỉ hiện những NCC có trạng thái 'đang giao dịch'
            if (NCC.getTrangThai()) {
                dcm.addElement(NCC);    
            }
        }
    ...
    void xoaThongTin() {
        ...
        txt_DinhMucTonLonNhat.setText("");
        txt_DinhMucTonLonNhat.setBackground(Color.white);
        txt_DinhMucTonNhoNhat.setText("");
        txt_DinhMucTonNhoNhat.setBackground(Color.white);
        txt_GiaVon.setText("");
        txt_GiaVon.setBackground(Color.white);
        txt_GiaBan.setText("");
    ...
    /*
     * Hàm thêm sản phẩm lên database và cập nhật lại frame DanhSachSanPham
     */
    void themSanPham() {
        try {
            if(kiemLoi()){
                SanPham model = taoModel();
                int rs = SanPhamDAO.themSanPham(model);
                if(rs != 0){
