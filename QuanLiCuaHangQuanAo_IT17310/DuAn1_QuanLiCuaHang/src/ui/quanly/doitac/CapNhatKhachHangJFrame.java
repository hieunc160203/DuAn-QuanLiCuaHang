 ...
 */
public class CapNhatKhachHangJFrame extends javax.swing.JFrame {

    private static KhachHang model;
    /**
     * Creates new form CapNhatKhachHangJFrame
     */
    public CapNhatKhachHangJFrame(KhachHang model) {
        initComponents();
        this.model = model;
        inIt();
    }
    ...
    private void initComponents() {
        ...
        txt_DiemThuong.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_DiemThuongKeyTyped(evt);
            }
        });
    ...
    private void txt_DiemThuongKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_DiemThuongKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
        if(!(Character.isDigit(c)) || c == KeyEvent.VK_DELETE || c == KeyEvent.VK_BACK_SPACE){
            evt.consume();
        }
    }//GEN-LAST:event_txt_DiemThuongKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhatKhachHangJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapNhatKhachHangJFrame(model).setVisible(true);
            }
        });
    }
    ...
    /*
     * Hàm tự động đổ thông tin khách hàng lên textfield
     */
    void doThongTin(){
        txt_MaKhachHang.setText(model.getMaKhachHang().trim());
        txt_HoTen.setText(model.getHoTen().trim());
        ...
        txt_NhanVienQuanLy.setText(model.getNVQuanLy().trim());
        ...
        txt_DiemThuong.setText(model.getDiemThuong()+"");
    }
    ...
    boolean checkDienThoai(){
        ...
        try {
            ...
            else if(!SDT.equalsIgnoreCase(model.getDienThoai()) && !KhachHangDAO.kiemSDT(SDT)){
                ketqua = false;
    ...
    boolean checkEmail(){
        try {
            ...
            if(!email.equalsIgnoreCase(model.getEmail().trim()) && !KhachHangDAO.kiemEmail(email)){
    ...
    /*
     * Hàm cập nhật thông tin khách hàng vào database
          sau khi thêm thì close frame này
     */
    void capnhatKhachHang(){
        try {
            if(kiemLoi()){
                KhachHang KH = taoModel();
                int rs = KhachHangDAO.capnhatKhachHang(KH);
                if(rs != 0){
    ...
    /*
     * Hàm kiểm lỗi trước khi cập nhật Khách hàng
     */
    boolean kiemLoi(){
    ...
    KhachHang taoModel(){
        ...
        KH.setDiemThuong(Integer.parseInt(txt_DiemThuong.getText()));
        KH.setDienThoai(txt_DienThoai.getText());
        KH.setGioiTinh(rad_Nam.isSelected());
        KH.setNgaySinh(dat_NgaySinh.getDate());
        KH.setNVQuanLy(txt_NhanVienQuanLy.getText());
        KH.setEmail(txt_Email.getText());
        KH.setDiaChi(txa_DiaChi.getText());
        KH.setGhiChu(txa_GhiChu.getText());
